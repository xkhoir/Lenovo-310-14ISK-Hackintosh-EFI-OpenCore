...
| ----------- | ----------- | ----------- | ----------- | 
| Lenovo Ideapad 310 14ISK 80SL | LENOVO Insyde 0XCN45WW (Lastest)| Bigsur 11.5 Beta (20G5042c) | [OpenCore v0.7.0](https://github.com/acidanthera/OpenCorePkg/releases) |
